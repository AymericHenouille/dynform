...
export interface DynForm<TValue, TData> {
   ...
   */
  updateValue(updateFn: UpdateValueFn<DynFormValue<TValue> | undefined>): void;
  /**
   * Patch the value of the controller.
   * @param value The new value for the controller.
   */
  patchValue(value: DynFormValue<Partial<TValue>>): void;
  /**
   ...
   */
  updatePlaceholder(updateFn: UpdateValueFn<string>): void;
  /**
   ...
   */
  updateData(updateFn: UpdateValueFn<TData | undefined>): void;
  /**
   * Patch the value of the controller data.
   * @param data The new data for the controller.
   */
  patchData(data: Partial<TData>): void;
  /**
   ...
   */
  updateContext(updateFn: UpdateValueFn<DynFormContext<TValue, TData>>): void;
  /**
   ...
   */
  updateHidden(updateFn: UpdateValueFn<boolean>): void;
  /**
   ...
   */
  updateVisible(updateFn: UpdateValueFn<boolean>): void;
}
